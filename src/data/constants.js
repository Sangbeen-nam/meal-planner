...
export const INGREDIENT_GROUPS = [
  ...
  {group:"🐟 해산물",items:[{n:"새우",e:"🦐"},{n:"참치",e:"🐟"},{n:"멸치",e:"🐠"},{n:"오징어",e:"🦑"},{n:"조개",e:"🦪"},{n:"연어",e:"🐡"},{n:"게맛살",e:"🦀"},{n:"전복",e:"🐚"},{n:"동태",e:"🐟"},{n:"미역",e:"🌊"},{n:"홍합",e:"🦪"},{n:"대구",e:"🐟"},{n:"황태",e:"🐟"},{n:"낙지",e:"🦑"},{n:"고등어",e:"🐟"},{n:"갈치",e:"🐟"},{n:"삼치",e:"🐟"},{n:"조기",e:"🐟"}]},
  {group:"🥬 잎채소",items:[{n:"시금치",e:"🥬"},{n:"깻잎",e:"🌿"},{n:"양배추",e:"🥬"},{n:"아욱",e:"🌿"},{n:"청경채",e:"🥬"},{n:"시래기",e:"🌿"},{n:"쑥",e:"🌿"},{n:"봄동",e:"🥬"},{n:"달래",e:"🌿"},{n:"열무",e:"🥬"},{n:"고사리",e:"🌿"},{n:"두릅",e:"🌿"},{n:"참취",e:"🌿"}]},
  {group:"🥕 뿌리채소",items:[{n:"당근",e:"🥕"},{n:"감자",e:"🥔"},{n:"고구마",e:"🍠"},{n:"무",e:"⬜"},{n:"연근",e:"🌾"},{n:"우엉",e:"🌿"},{n:"도라지",e:"🌿"}]},
  {group:"🍅 열매채소",items:[{n:"토마토",e:"🍅"},{n:"파프리카",e:"🫑"},{n:"가지",e:"🍆"},{n:"애호박",e:"🥒"},{n:"단호박",e:"🎃"},{n:"아보카도",e:"🥑"},{n:"피망",e:"🫑"}]},
  {group:"🌿 기타채소",items:[{n:"양파",e:"🧅"},{n:"대파",e:"🌿"},{n:"버섯",e:"🍄"},{n:"콩나물",e:"🌱"},{n:"브로콜리",e:"🥦"},{n:"숙주",e:"🌱"}]},
  {group:"🥚 단백질/유제품",items:[{n:"계란",e:"🥚"},{n:"두부",e:"⬜"},{n:"치즈",e:"🧀"},{n:"우유",e:"🥛"},{n:"요거트",e:"🫙"},{n:"버터",e:"🧈"}]},
  {group:"🌾 곡류/면류",items:[{n:"쌀",e:"🍚"},{n:"현미",e:"🌾"},{n:"흑미",e:"🌾"},{n:"메밀",e:"🟤"},{n:"밀가루",e:"🌾"},{n:"면",e:"🍝"},{n:"당면",e:"🍜"},{n:"떡",e:"🍡"}]},
  {group:"🥜 견과/기타",items:[{n:"잣",e:"🌰"},{n:"팥",e:"🫘"},{n:"녹두",e:"🫘"},{n:"묵",e:"⬜"},{n:"깨",e:"🌰"}]},
