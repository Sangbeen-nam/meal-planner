...
const RICE_DB = [
  ...
  {name:"시금치달걀볶음밥",safeFor:"baby",tags:["한식","볶음"],ingredients:["시금치","계란","쌀"],time:15,diff:"쉬움",cal:380,nutrition:{protein:14,calcium:88,iron:2.8,vitC:20,fiber:2.0},serving:"밥 200g, 시금치 80g, 계란 2개, 간장 1작은술(5ml), 참기름 1작은술(5ml), 소금 약간, 식용유 1큰술",steps:["시금치 80g을 끓는 소금물에 20초 데쳐 찬물에 헹군다","물기를 꼭 짜고 2cm 길이로 썬다","계란 2개를 풀어 소금으로 간한다","팬에 기름 10ml를 강불로 달궈 계란을 스크램블로 익혀 빼둔다","같은 팬에 기름 5ml로 시금치를 30초 볶는다","찬밥 200g을 넣고 강불에서 2분 볶는다","계란을 다시 넣고 간장 5ml로 간한다","참기름 5ml 두르고 마무리 — 시금치 철분과 계란 단백질의 황금 조합"]},
  {name:"소고기채소죽",safeFor:"baby",tags:["한식","죽/스프"],ingredients:["소고기","당근","애호박","쌀"],time:40,diff:"쉬움",cal:240,nutrition:{protein:16,calcium:25,iron:2.2,vitC:10,fiber:1.8},serving:"쌀 90g(불린 것), 소고기(다짐육) 60g, 당근 30g, 애호박 30g, 물 500ml, 참기름 1작은술, 국간장 1/2작은술",steps:["쌀 90g을 찬물에 30분 불린다","소고기 60g, 당근·애호박 각 30g을 0.3cm로 아주 잘게 다진다","냄비에 참기름 5ml로 소고기를 2분 볶는다","당근·애호박을 넣고 1분 더 볶는다","불린 쌀을 넣고 1분 볶은 뒤 물 500ml를 붓는다","강불로 끓이다가 약불로 줄여 20분 저어가며 끓인다","국간장으로 간을 맞춘다 — 영아·유아의 완전식으로 채소를 더 잘게 다져도 좋음"]},
  {name:"두부채소덮밥",safeFor:"baby",tags:["한식","덮밥"],ingredients:["두부","당근","양파","쌀"],time:20,diff:"쉬움",cal:380,nutrition:{protein:16,calcium:122,iron:1.5,vitC:8,fiber:2.2},serving:"밥 200g, 두부 1/3모(150g), 당근 40g, 양파 60g, 간장 1큰술(15ml), 설탕 1/2작은술, 참기름 1작은술, 전분물(전분 1작은술+물 2큰술)",steps:["두부 150g을 1.5cm 깍뚝으로 썬다","키친타올로 물기를 충분히 제거한다","당근 40g은 작게 깍뚝, 양파 60g은 잘게 다진다","팬에 기름 10ml를 두르고 양파와 당근을 2분 볶는다","두부를 넣고 2분 더 볶는다","간장 15ml, 설탕 2.5g을 넣고 1분 볶는다","전분물을 부어 소스를 걸쭉하게 만든다","밥 위에 올리고 참기름 5ml 뿌려 완성"]},
  {name:"멸치주먹밥",safeFor:"toddler",tags:["한식"],ingredients:["쌀","멸치"],time:20,diff:"쉬움",cal:320,nutrition:{protein:12,calcium:185,iron:1.8,vitC:2,fiber:0.8},serving:"밥 200g, 잔멸치 40g, 간장 1/2큰술(7.5ml), 설탕 1/4작은술, 물엿 1작은술(5g), 참기름 1작은술, 통깨",steps:["잔멸치 40g을 마른 팬에 2분 볶아 비린내를 제거한다","간장 7.5ml, 설탕 1g, 물엿 5g을 넣고 1분 더 볶아 양념 멸치를 만든다","참기름 5ml를 두르고 불을 끈다","따뜻한 밥 200g에 양념 멸치와 통깨를 넣어 섞는다","한입 크기 삼각형이나 동그란 모양으로 빚는다 — 손에 물을 살짝 묻히면 달라붙지 않음","통깨를 겉에 굴려 완성"]},
  {name:"미역줄기볶음밥",safeFor:"toddler",tags:["한식","볶음"],ingredients:["쌀","미역","계란"],time:15,diff:"쉬움",cal:350,nutrition:{protein:10,calcium:125,iron:2.0,vitC:3,fiber:2.5},serving:"밥 200g, 미역줄기(염장 또는 생) 80g, 계란 1개, 참기름 1큰술(15ml), 간장 1작은술(5ml), 다진마늘 1/2작은술, 통깨",steps:["미역줄기 80g을 찬물에 30분 담가 짠기를 빼고 4cm 길이로 썬다","계란 1개를 스크램블로 익혀 빼둔다","팬에 참기름 15ml로 다진마늘을 30초 볶는다","미역줄기를 넣고 2분 볶는다","찬밥 200g을 넣고 강불에서 2분 볶는다","계란을 넣고 간장 5ml로 간한다","통깨 뿌려 마무리"]},
  {name:"소시지야채볶음밥",safeFor:"kid1",isProcessed:true,tags:["한식","볶음"],ingredients:["소시지","당근","양파","쌀","계란"],time:15,diff:"쉬움",cal:430,nutrition:{protein:14,calcium:30,iron:1.0,vitC:15,fiber:1.5},serving:"밥 200g, 소시지 3개(90g), 당근 40g, 양파 60g, 계란 1개, 간장 1작은술(5ml), 식용유 1큰술",steps:["소시지 90g을 0.5cm 두께 동전 모양으로 썬다","당근 40g은 작게 깍뚝, 양파 60g은 잘게 다진다","팬에 기름 10ml로 소시지를 1분 볶는다","당근·양파를 넣고 2분 볶는다","찬밥 200g을 넣고 강불에서 2분 볶는다","계란을 풀어 넣고 빠르게 섞는다","간장 5ml, 소금으로 간하고 마무리 — 주 1~2회 적당히 즐기기"]},
  {name:"햄채소주먹밥",safeFor:"kid1",isProcessed:true,tags:["한식"],ingredients:["햄","당근","시금치","쌀"],time:20,diff:"쉬움",cal:360,nutrition:{protein:12,calcium:38,iron:1.2,vitC:18,fiber:1.5},serving:"밥 200g, 햄 80g, 당근 40g, 시금치 50g, 참기름 1작은술, 소금 약간, 통깨",steps:["햄 80g을 0.5cm 작은 깍뚝으로 썬다","당근 40g을 잘게 다져 전자레인지에 1분 익힌다","시금치 50g을 끓는 물에 20초 데쳐 찬물에 헹구고 잘게 썬다","팬에 기름 없이 햄을 1분 볶는다","따뜻한 밥 200g에 햄·당근·시금치·참기름·소금을 넣어 섞는다","손에 물을 묻혀 삼각형 주먹밥을 빚는다","통깨를 겉에 굴려 완성"]},
];
...
const SOUP_DB = [
  ...
  {name:"황태국",safeFor:"baby",tags:["한식","국/찌개"],ingredients:["계란","두부"],time:20,diff:"쉬움",cal:110,nutrition:{protein:15,calcium:38,iron:0.8,vitC:0,fiber:0.3},serving:"황태채 25g, 계란 1개, 두부 1/8모(50g), 물 500ml, 참기름 1작은술, 국간장 1큰술, 다진마늘 1/2작은술",steps:["황태채 25g을 찬물에 5분 담갔다가 꼭 짜고 3cm로 자른다","냄비에 참기름 5ml를 두르고 황태채를 2분 볶는다","물 500ml를 붓고 강불로 끓인다","다진마늘·국간장을 넣고 중불 10분 끓인다","두부 50g을 1cm 깍뚝으로 넣고 3분 끓인다","계란 1개를 풀어 가늘게 넣고 30초 익힌다","소금으로 최종 간을 맞춘다"]},
  {name:"애호박된장국",safeFor:"toddler",tags:["한식","국/찌개"],ingredients:["애호박","된장","두부"],time:15,diff:"쉬움",cal:95,nutrition:{protein:7,calcium:58,iron:1.0,vitC:6,fiber:1.5},serving:"애호박 1/2개(150g), 된장 1큰술(15g), 두부 1/8모(50g), 멸치육수 400ml, 다진마늘 1/2작은술",steps:["멸치육수 400ml를 냄비에 끓인다","된장 15g을 체에 걸러 풀어준다","애호박 150g을 0.5cm 두께 반달 모양으로 썬다","다진마늘과 애호박을 넣고 5분 끓인다","두부 50g을 1.5cm 깍뚝으로 넣고 3분 더 끓인다","소금으로 간 맞추고 대파로 마무리"]},
  {name:"냉이된장국",safeFor:"baby",tags:["한식","국/찌개"],ingredients:["된장"],time:15,diff:"쉬움",cal:80,nutrition:{protein:5,calcium:68,iron:1.5,vitC:12,fiber:2.0},serving:"냉이 80g, 된장 1큰술(15g), 멸치육수 400ml, 다진마늘 1/2작은술",steps:["냉이 80g을 뿌리째 흙이 없도록 깨끗이 씻는다","냉이 뿌리는 그대로 두고 3cm 길이로 썬다","멸치육수 400ml를 끓인다","된장 15g을 체에 걸러 풀어준다","냉이와 다진마늘을 넣고 3분만 끓인다 — 오래 끓이면 향이 날아감","소금으로 간 맞추고 완성"]},
  {name:"표고버섯국",safeFor:"baby",tags:["한식","국/찌개"],ingredients:["버섯"],time:15,diff:"쉬움",cal:75,nutrition:{protein:4,calcium:15,iron:0.6,vitC:2,fiber:2.2},serving:"표고버섯 4개(120g), 멸치육수 400ml, 국간장 1큰술(15ml), 다진마늘 1/2작은술, 대파 1/4대",steps:["표고버섯 120g의 기둥을 제거하고 갓을 0.5cm 두께로 편 썬다","멸치육수 400ml를 끓인다","표고버섯과 다진마늘을 넣고 7분 끓인다","국간장 15ml로 간한다","대파를 송송 썰어 올리고 소금으로 최종 간 맞춘다"]},
  {name:"시래기된장국",safeFor:"toddler",tags:["한식","국/찌개"],ingredients:["된장"],time:25,diff:"쉬움",cal:90,nutrition:{protein:5,calcium:88,iron:1.8,vitC:8,fiber:4.5},serving:"삶은 시래기 100g, 된장 1큰술(15g), 멸치육수 400ml, 다진마늘 1/2작은술, 들기름 1작은술",steps:["삶은 시래기 100g을 찬물에 씻어 3cm 길이로 썬다","냄비에 들기름 5ml로 시래기를 1분 볶는다","멸치육수 400ml를 붓고 끓인다","된장 15g을 체에 걸러 풀어준다","다진마늘을 넣고 중불에서 15분 끓인다","소금으로 간 맞추고 대파로 마무리"]},
  {name:"근대된장국",safeFor:"baby",tags:["한식","국/찌개"],ingredients:["된장"],time:15,diff:"쉬움",cal:75,nutrition:{protein:4,calcium:92,iron:1.5,vitC:20,fiber:2.0},serving:"근대 100g, 된장 1큰술(15g), 멸치육수 400ml, 다진마늘 1/2작은술",steps:["근대 100g을 줄기와 잎을 분리해 씻는다","멸치육수 400ml를 끓인다","된장 15g을 체에 걸러 풀어준다","줄기를 먼저 넣고 2분 끓인다","잎과 다진마늘을 넣고 2분 더 끓인다 — 근대는 오래 끓이면 물러짐","소금으로 간 맞추고 완성"]},
  {name:"무된장국",safeFor:"baby",tags:["한식","국/찌개"],ingredients:["무","된장"],time:15,diff:"쉬움",cal:80,nutrition:{protein:4,calcium:35,iron:0.5,vitC:12,fiber:1.2},serving:"무 150g, 된장 1큰술(15g), 멸치육수 400ml, 다진마늘 1/2작은술",steps:["무 150g을 1.5cm 나박 모양으로 썬다","멸치육수 400ml를 끓인다","된장 15g을 체에 걸러 풀어준다","무와 다진마늘을 넣고 10분 끓인다 — 무가 투명해지면 완성","소금으로 간 맞추고 대파 올려 마무리"]},
  {name:"두부된장국",safeFor:"baby",tags:["한식","국/찌개"],ingredients:["두부","된장"],time:12,diff:"쉬움",cal:100,nutrition:{protein:9,calcium:112,iron:1.2,vitC:2,fiber:0.8},serving:"두부 1/3모(150g), 된장 1큰술(15g), 멸치육수 400ml, 다진마늘 1/2작은술, 대파 1/4대",steps:["두부 150g을 1.5cm 깍뚝으로 썬다","멸치육수 400ml를 끓인다","된장 15g을 체에 걸러 풀어준다","다진마늘을 넣고 2분 끓인다","두부를 넣고 3분 더 끓인다 — 두부는 오래 끓이면 질겨짐","대파를 올려 마무리"]},
  {name:"대파국",safeFor:"baby",tags:["한식","국/찌개"],ingredients:["대파","계란"],time:12,diff:"쉬움",cal:90,nutrition:{protein:7,calcium:48,iron:0.8,vitC:15,fiber:1.5},serving:"대파 2대(200g), 계란 1개, 멸치육수 400ml, 국간장 1큰술(15ml), 참기름 1/2작은술",steps:["대파 200g을 2cm 어슷썬다","멸치육수 400ml를 냄비에 끓인다","국간장 15ml로 간한다","대파를 넣고 3분 끓인다","계란 1개를 풀어 가늘게 붓고 10초 후 한 번 젓는다","참기름 2.5ml 두르고 마무리 — 대파의 항균 성분이 감기 예방에 효과적"]},
];
...
const SIDE_DB = [
  ...
  {name:"닭고기완자",safeFor:"baby",tags:["찜","한식"],ingredients:["닭고기","계란","당근","양파"],time:25,diff:"보통",cal:220,nutriType:"단백질",nutrition:{protein:18,calcium:28,iron:1.2,vitC:3,fiber:0.3},serving:"닭가슴살 다짐육 120g, 계란 1/2개, 당근 20g, 양파 20g, 빵가루 1큰술(10g), 소금 1/4작은술",steps:["당근·양파 각 20g을 아주 잘게 다진다","닭 다짐육 120g에 계란 1/2개·빵가루·소금을 넣고 치댄다","당근·양파를 넣어 다시 치댄다","지름 3cm 동그란 완자로 빚는다","찜기에 올려 강불 10분 찐다","또는 팬에 기름을 두르고 굴려가며 굽는다"]},
  {name:"두부달걀찜",safeFor:"baby",tags:["찜"],ingredients:["두부","계란"],time:18,diff:"쉬움",cal:155,nutriType:"단백질",nutrition:{protein:14,calcium:142,iron:2.0,vitC:0,fiber:0.3},serving:"두부 1/4모(100g), 계란 2개, 육수 80ml, 소금 1/4작은술, 참기름 1/2작은술",steps:["두부 100g을 손으로 으깨 고운 체에 내려 부드럽게 만든다","계란 2개를 풀어 육수 80ml와 함께 섞는다","으깬 두부를 넣고 소금·참기름을 넣어 잘 섞는다","고운 체에 걸러 기포를 없앤다","내열 그릇에 담고 물 있는 냄비에 넣어 약불 15분 찐다","이쑤시개로 찔러 맑은 물이 나오면 완성"]},
  {name:"고등어조림",safeFor:"kid1",tags:["한식","구이"],ingredients:["고등어","무","간장"],time:25,diff:"보통",cal:285,nutriType:"단백질",nutrition:{protein:22,calcium:35,iron:1.2,vitC:5,fiber:0.8},serving:"고등어 1/2마리(150g), 무 100g, 간장 1.5큰술(22ml), 고추장 1작은술(5g), 다진마늘 1작은술, 생강즙 1/4작은술, 물 100ml",steps:["고등어 150g을 3등분으로 자르고 칼집을 넣는다","끓는 물에 30초 데쳐 비린내를 제거한다","무 100g을 1.5cm 두께로 썰어 냄비 바닥에 깐다","간장·고추장·다진마늘·생강즙·물 100ml를 섞어 양념장을 만든다","무 위에 고등어를 올리고 양념장을 붓는다","강불 5분, 중불 10분 조린다","국물을 끼얹어가며 윤기 나게 완성"]},
  {name:"참치야채전",safeFor:"toddler",isProcessed:true,tags:["튀김/전"],ingredients:["참치","당근","양파","계란"],time:18,diff:"쉬움",cal:250,nutriType:"단백질",nutrition:{protein:16,calcium:42,iron:1.2,vitC:8,fiber:1.0},serving:"참치캔 1캔(100g), 당근 30g, 양파 40g, 계란 1개, 부침가루 3큰술(30g), 소금 약간",steps:["참치캔을 체에 밭쳐 기름을 완전히 뺀다","당근 30g, 양파 40g을 아주 잘게 다진다","참치·채소·계란·부침가루·소금을 볼에 넣고 섞는다","팬에 기름 10ml를 두르고 중불로 달군다","반죽을 1큰술씩 올려 지름 5cm 원형으로 편다","앞뒤 각 3분씩 노릇하게 굽는다"]},
  {name:"소시지야채볶음",safeFor:"kid1",isProcessed:true,tags:["볶음"],ingredients:["소시지","당근","파프리카","양파"],time:12,diff:"쉬움",cal:240,nutriType:"단백질",nutrition:{protein:10,calcium:22,iron:0.8,vitC:30,fiber:1.5},serving:"소시지 3개(90g), 당근 40g, 파프리카 1/2개(80g), 양파 1/4개(50g), 간장 1/2작은술(2.5ml), 케첩 1큰술(15g)",steps:["소시지 90g을 1cm 두께 동전 모양으로 썬다","당근 40g, 파프리카 80g, 양파 50g을 1cm 크기로 썬다","팬에 기름 10ml를 중불로 달군다","당근을 먼저 1분 볶는다","소시지를 넣고 1분 볶는다","파프리카·양파를 넣고 2분 볶는다","간장 2.5ml, 케첩 15g을 넣어 1분 더 볶는다"]},
  {name:"햄야채볶음",safeFor:"kid1",isProcessed:true,tags:["볶음"],ingredients:["햄","양파","당근"],time:10,diff:"쉬움",cal:215,nutriType:"단백질",nutrition:{protein:10,calcium:18,iron:0.6,vitC:10,fiber:1.0},serving:"햄 100g, 양파 1/4개(50g), 당근 40g, 간장 1/2작은술(2.5ml), 식용유 1큰술",steps:["햄 100g을 1cm 깍뚝으로 썬다","양파 50g, 당근 40g을 1cm 크기로 썬다","팬에 기름 10ml를 중불로 달군다","당근을 먼저 1분 볶는다","햄과 양파를 넣고 2분 볶는다","간장 2.5ml로 간하고 마무리"]},
  {name:"숙주나물",safeFor:"baby",tags:["찜","한식"],ingredients:["콩나물"],time:8,diff:"쉬움",cal:65,nutriType:"채소",nutrition:{protein:3,calcium:28,iron:0.6,vitC:10,fiber:1.2},serving:"숙주(녹두나물) 150g, 간장 1/2작은술(2.5ml), 참기름 1작은술(5ml), 다진마늘 1/3작은술, 소금 약간, 통깨",steps:["숙주 150g을 물에 씻어 상한 것을 골라낸다","끓는 소금물에 뚜껑 닫고 2분 데친다 — 뚜껑 열면 비린내 남","찬물에 헹궈 물기를 꼭 짠다","간장·참기름·다진마늘·소금으로 무친다","통깨 뿌려 완성"]},
  {name:"무생채",safeFor:"toddler",tags:["한식"],ingredients:["무"],time:10,diff:"쉬움",cal:55,nutriType:"채소",nutrition:{protein:1,calcium:28,iron:0.4,vitC:18,fiber:1.5},serving:"무 200g, 식초 1큰술(15ml), 설탕 1/2큰술(5g), 소금 1/2작은술, 고춧가루 1/4작은술(어린아이는 생략), 다진마늘 1/4작은술",steps:["무 200g을 가늘게 채썬다","소금 2.5g을 뿌려 10분 절인다","물기를 손으로 꼭 짠다","식초·설탕·다진마늘·고춧가루를 섞어 양념을 만든다","무채에 양념을 넣고 무친다","통깨로 마무리 — 고춧가루는 아이 연령에 맞게 가감"]},
  {name:"도라지나물",safeFor:"kid1",tags:["한식"],ingredients:["도라지"],time:20,diff:"보통",cal:80,nutriType:"채소",nutrition:{protein:2,calcium:58,iron:0.5,vitC:5,fiber:3.5},serving:"도라지 100g, 소금 1작은술(쓴맛 제거용), 간장 1/2작은술, 참기름 1작은술, 다진마늘 1/2작은술, 통깨",steps:["도라지 100g을 가늘게 찢거나 채썬다","소금 5g을 넣고 주물러 10분 절인 뒤 찬물에 3회 헹군다 — 쓴맛 제거","물기를 꼭 짠다","끓는 물에 2분 데쳐 찬물에 헹군다","간장·참기름·다진마늘로 무친다","팬에 기름 5ml를 두르고 1분 볶아 마무리 — 볶으면 쓴맛이 완전히 사라짐"]},
  {name:"냉동완두콩볶음",safeFor:"kid1",isProcessed:true,tags:["볶음"],ingredients:["냉동완두콩","버터"],time:8,diff:"쉬움",cal:130,nutriType:"채소",nutrition:{protein:5,calcium:22,iron:1.2,vitC:12,fiber:4.0},serving:"냉동완두콩 100g, 버터 5g, 소금 1/4작은술, 후추 약간",steps:["냉동완두콩 100g을 끓는 물에 2분 데친다","찬물에 헹궈 식힌다","팬에 버터 5g을 녹인다","완두콩을 넣고 1분 볶는다","소금·후추로 간한다","단순하지만 단백질과 식이섬유가 풍부한 반찬"]},
  {name:"옥수수버터볶음",safeFor:"kid1",isProcessed:true,tags:["볶음"],ingredients:["냉동옥수수","버터"],time:8,diff:"쉬움",cal:160,nutriType:"채소",nutrition:{protein:3,calcium:5,iron:0.5,vitC:8,fiber:2.5},serving:"냉동옥수수 100g, 버터 8g, 소금 1/4작은술, 설탕 1/4작은술, 파슬리 약간",steps:["냉동옥수수 100g을 전자레인지 2분 또는 끓는 물에 1분 데친다","팬에 버터 8g을 녹인다","옥수수를 넣고 중불에서 2분 볶는다","소금·설탕으로 간한다","파슬리를 살짝 뿌리면 더욱 맛있다"]},
  {name:"청경채볶음",safeFor:"baby",tags:["볶음"],ingredients:["청경채","마늘"],time:8,diff:"쉬움",cal:72,nutriType:"채소",nutrition:{protein:2,calcium:90,iron:0.8,vitC:45,fiber:1.8},serving:"청경채 200g(3~4개), 다진마늘 1작은술(5g), 굴소스 1/2큰술(7.5ml), 참기름 1작은술, 소금 약간",steps:["청경채 200g을 반으로 갈라 흐르는 물에 씻는다","팬에 기름 10ml를 강불로 달군다","다진마늘 5g을 30초 볶는다","청경채를 넣고 강불에서 2분 볶는다 — 강불 단시간이 아삭함의 비결","굴소스 7.5ml, 소금으로 간한다","참기름 5ml 두르고 마무리"]},
  {name:"시래기나물",safeFor:"toddler",tags:["한식"],ingredients:["시래기","된장"],time:20,diff:"쉬움",cal:85,nutriType:"채소",nutrition:{protein:3,calcium:98,iron:1.8,vitC:10,fiber:5.0},serving:"삶은 시래기 100g, 된장 1/2작은술(2.5g), 들기름 1작은술(5ml), 다진마늘 1/2작은술, 국간장 1/2작은술, 통깨",steps:["삶은 시래기 100g을 찬물에 씻어 물기를 꼭 짠다","3cm 길이로 썬다","된장·다진마늘·국간장을 넣고 조물조물 무친다","팬에 들기름 5ml를 두르고 중불에서 3분 볶는다","통깨로 마무리 — 들기름이 시래기 나물의 핵심"]},
];
